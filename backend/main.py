...
async def send_message(conversation_id: str, request: SendMessageRequest):
    ...
    storage.add_user_message(conversation_id, request.content, files=files_dict)
    ...
    # Construct the full prompt for LLM context
    full_prompt = build_prompt_content(request.content, request.files)
